...
A random forest model was trained to accurately identify each of these classifications using the relevant sensor data. The in-sample accuracy of the trained model was estimated using 10% of the training data that was set aside prior to training.
...
Due to the high accuracy of the model, 10% of the training data was partitioned to better estimate the in-sample accuracy of the model. The accuracy of the set, called the training-test set, was 97.2%.
